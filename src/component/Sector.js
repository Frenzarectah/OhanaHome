...
const Sector = ()=>{
    return(
        <h1 id="home" className="w-full font-Roboto text-md flex flex-col md:flex-row">
            <div className="w-full md:w-[75%] my-5 p-1">
            ...
            <iframe title="verona video" className="w-full aspect-auto my-5 p-1" src="https://www.youtube-nocookie.com/embed/4_S8_G6SPIg"></iframe>
